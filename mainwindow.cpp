...
void MainWindow::on_cbIndexColor_currentIndexChanged(int index)
{
    if(index == 0)
        ui->screen->SetIndexColor(0);
    else
        ui->screen->SetIndexColor(16);
}
...
{
    QString fileName = QFileDialog::getOpenFileName(this, "Найти файл", "", "*.scr");
...
{
    QMessageBox::about(this , "About", "Зачем сюда нажали?");
}
...
{
    QString fileName = QFileDialog::getOpenFileName(this,"Выберите папку и название файла", "", "*.z80");
        load_z80(fileName);
}
